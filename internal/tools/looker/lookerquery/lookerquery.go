...
func (cfg Config) Initialize(srcs map[string]sources.Source) (tools.Tool, error) {
	...
	filtersParameter := tools.NewObjectParameterWithDefault("filters",
		map[string]any{},
		"The filters for the query",
		map[string]tools.Parameter{},
	)
	...
	tzParameter := tools.NewStringParameterWithDefault("tz", "Etc/UTC", "The query timezone.")
...
func (t Tool) Invoke(ctx context.Context, params tools.ParamValues) (any, error) {
	...
	fields := f.([]string)
	logger.ErrorContext(ctx, fmt.Sprintf("filters = %v %T", paramsMap["filters"], paramsMap["filters"]))
